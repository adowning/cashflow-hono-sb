...
import { gameSessionTable, sessionTable, userBalanceTable, userTable } from "./user";
...
export const transactionRelations = relations(transactionLogTable, ({ one }) => ({
	user: one(userTable, {
...
export const affiliatePayoutRelations = relations(affiliatePayoutTable, ({ one }) => ({

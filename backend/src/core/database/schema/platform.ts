...
export const PlatformSettingSelectSchema = createSelectSchema(platformSettingTable);
export const PlatformSettingInsertSchema = createInsertSchema(platformSettingTable);
export const PlatformSettingUpdateSchema = createUpdateSchema(platformSettingTable);
...
export type PlatformSettingSelect = typeof platformSettingTable.$inferSelect & PlatformSetting;

...
export const AffiliatePayoutSelectSchema = createSelectSchema(affiliatePayoutTable);
export const AffiliatePayoutInsertSchema = createInsertSchema(affiliatePayoutTable);
export const AffiliatePayoutUpdateSchema = createUpdateSchema(affiliatePayoutTable);
